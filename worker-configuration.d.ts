/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 1e9f4b4109512b5d6dc466fb6e3e514b)
// Runtime types generated with workerd@1.20260730.1 2026-07-01 
interface __BaseEnv_Env {
	DB: D1Database;
	RP_ID: "localhost";
	RP_NAME: "Shared Todo";
	RP_ORIGIN: "http://localhost:7642";
	SESSION_SECRET: string;
	LIST_ROOM: DurableObjectNamespace<import("./src/worker/index").ListRoom>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/worker/index");
		durableNamespaces: "ListRoom";
	}
